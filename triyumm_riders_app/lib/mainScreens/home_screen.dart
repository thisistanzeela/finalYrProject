...
import 'package:triyumm_riders_app/mainScreens/new_orders_screen.dart';
import 'package:triyumm_riders_app/mainScreens/not_yet_delivered.dart';
import 'package:triyumm_riders_app/mainScreens/parcel_in_progress_screen.dart';
        ...
        child: InkWell(
          onTap: ()
          {
            ...
            if(index == 1)
            {
              //Parcels in Progress
              Navigator.push(context, MaterialPageRoute(builder
                  : (c)=> ParcelInProgressScreen()));
            }
            if(index == 2)
            {
              //Not Yet Delivered
              Navigator.push(context, MaterialPageRoute(builder
                  : (c)=> NotYetDeliveredScreen()));
            }
            if(index == 3)
            {
              //History
