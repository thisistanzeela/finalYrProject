...
import 'package:triyumm_riders_app/assistantMethods/get_current_location.dart';
import 'package:triyumm_riders_app/global/global.dart';
import 'package:triyumm_riders_app/maps/map_utils.dart';
import 'package:triyumm_riders_app/splashScreen/splash_screen.dart';
...
class _ParcelDeliveringScreenState extends State<ParcelDeliveringScreen>
{
  ...
  confirmParcelHasBeenDelivered(getOrderId, sellerId, purchaserId, purchaserAddress, purchaserLat, purchaserLng)
  {
    ...
    }).then((value)
    {
      FirebaseFirestore.instance
          ...
          .update(
          {
            "earnings": riderNewTotalEarningAmount, //total earning of rider
          });
    }).then((value)
    {
      FirebaseFirestore.instance
          ...
          .update(
          {
            "earnings": (double.parse(orderTotalAmount) + (double.parse(previousEarning))).toString(), //total earning amount of seller
          });
    }).then((value) {
      FirebaseFirestore.instance
          .collection("users")
          ...
          {
            "status": "ended",
            "riderUID": sharedPreferences!.getStringList("uid"),
          });
    });
  ...
  getSellerData()
  {
    FirebaseFirestore.instance
        ...
        .get().then((snap)
    {
     previousEarning = snap.data()!["earnings"].toString();
    });
  }
